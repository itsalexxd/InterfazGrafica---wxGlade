...
class BLACKJACK(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        ## MUSICA BOTON BITMAP ##
        #########################
        self.bitmapLuigiDealer = wx.BitmapButton(self.panel_blackjack, wx.ID_ANY, wx.Bitmap("./musica.png", wx.BITMAP_TYPE_ANY))
        ...
        self.barajear_gif.LoadFile("./luigiBarajea.gif")
        ...
        self.repartir_gif.LoadFile("./luigiReparte.gif")
    ...
    def sonidoAmbiente(self, event):  # wxGlade: BLACKJACK.<event_handler>
        sound = wx.adv.Sound("./luigiMusica.wav")
        if self.isPlaying:
            wx.adv.Sound.Stop()
            self.isPlaying = False
        else:
    ...
    def balancePartida(self):
        ...
        if balancePart < 0:
            balanceNegativo = wx.adv.Sound("./balanceNegativo.wav")
            ...
            if self.hayBlackjack == False:
                balancePostivo = wx.adv.Sound("./balancePositivo.wav")
...
class BlackJack(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        bitmap_1 = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap("./blackjack.jpg", wx.BITMAP_TYPE_ANY))
        ...
        sonido = wx.adv.Sound("./blackjack.wav")
        if sonido.IsOk():
...
class MyApp(wx.App):
    def OnInit(self):
        ...
        sonido = wx.adv.Sound("./luigiVoz.wav")
        if sonido.IsOk():
            sonido.Play(wx.adv.SOUND_ASYNC) 
